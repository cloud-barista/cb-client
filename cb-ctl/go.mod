...
require github.com/cloud-barista/cb-tumblebug v0.6.4
...
require (
	...
	github.com/cloud-barista/cb-spider v0.6.8 // indirect
	github.com/cloud-barista/cb-store v0.6.2 // indirect
